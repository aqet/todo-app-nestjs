...
export declare class TodosController {
    ...
    createTodo(newTodo: any, req: any): import("mongoose").Query<(import("mongoose").Document<unknown, {}, import("./schemas/Todo.schemas").Todo, {}, {}> & import("./schemas/Todo.schemas").Todo & {
        _id: import("mongoose").Types.ObjectId;
    } & {
        __v: number;
